...
<template>
	<div>
		<div class="relative max-w-5xl mx-auto pt-20 sm:pt-24 lg:pt-28">
			<div class="flex justify-center">
				<div class="w-40 text-cyan-400 dark:text-white">
					<svg
						version="1.1"
						id="Layer_1"
	...
	c0-30.5,5.8-59.7,16.7-86.5L484.4,669l69-116.7l68.5,116.5l83.8-142.5H785C772,642.8,673.3,733.2,553.4,733.2z"
		...
		<div class="relative flex flex-col items-center overflow-hidden p-8">
			<div class="w-full max-w-xl rounded-2xl bg-white px-20 py-12">
				<div class="flex flex-col items-center">
					<p class="my-3 text-center text-black/80">
						This is the result of your <code class="font-mono text-amber-500 font-bold">Dragons</code> operation.
					</p>
					<ul>
						<li v-for="dragon in data?.spacex_dragons" :key="dragon.id">
							{{ dragon }}
						</li>
					</ul>
				</div>
			</div>
			<footer class="flex justify-between text-gray-400">
				<p class="pt-3">
					Visit
					<a
